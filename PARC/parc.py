...
class PARC:
    ...
    def __init__(self, K=10, alpha=1.0e-5, sigma=1, separation=None,
                 maxiter=100, cost_tol=1e-4, min_number=None,
                 fit_on_partition=True, softmax_solver='lbfgs',
                 softmax_maxiter=None, beta=None, initialization=None,
                 verbose=None):
    ...
    def fit(self, X, Y, categorical, weights=None, feature_selection=None, ):
        '''
        ...
        np.array(categorical, dtype=bool)  # convert to np.array and Boolean type
        ...
        if self.softmax_maxiter is None:
    ...
    def plot_partition(self, xmin, xmax, ind=None, values=None, fontsize=None, **kwargs):
        '''
